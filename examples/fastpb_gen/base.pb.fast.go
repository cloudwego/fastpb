...
func (x *Base) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.LogID, offset, err = fastpb.ReadString(buf[offset:], _type)
	return offset, err
}

func (x *Base) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Caller, offset, err = fastpb.ReadString(buf[offset:], _type)
	return offset, err
}

func (x *Base) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.Addr, offset, err = fastpb.ReadString(buf[offset:], _type)
	return offset, err
}

func (x *Base) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.Client, offset, err = fastpb.ReadString(buf[offset:], _type)
	return offset, err
}
...
func (x *BaseResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.StatusMessage, offset, err = fastpb.ReadString(buf[offset:], _type)
	return offset, err
}

func (x *BaseResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.StatusCode, offset, err = fastpb.ReadInt32(buf[offset:], _type)
	return offset, err
}
