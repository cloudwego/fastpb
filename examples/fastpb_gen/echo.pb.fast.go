...
func (x *Message) fastReadField20(buf []byte, _type int8) (offset int, err error) {
	var v string
	v, offset, err = fastpb.ReadString(buf[offset:], _type)
	if err != nil {
		return offset, err
	}
...
func (x *Message) fastReadField22(buf []byte, _type int8) (offset int, err error) {
	...
	offset, err = fastpb.ReadMapEntry(buf[offset:], _type,
		...
		func(buf []byte, _type int8) (offset int, err error) {
			value, offset, err = fastpb.ReadString(buf[offset:], _type)
			return offset, err
		})
	if err != nil {
		return offset, err
...
func (x *Message) fastReadField27(buf []byte, _type int8) (offset int, err error) {
	var v int32
	v, offset, err = fastpb.ReadInt32(buf[offset:], _type)
	if err != nil {
		return offset, err
	}
	x.Field27 = Enum(v)
...
func (x *Message) fastReadField28(buf []byte, _type int8) (offset int, err error) {
	offset, err = fastpb.ReadList(buf[offset:], _type,
...
func (x *Message) fastReadField41(buf []byte, _type int8) (offset int, err error) {
	...
	x.Field40 = &ov
	ov.Field41, offset, err = fastpb.ReadInt64(buf[offset:], _type)
	return offset, err
}
...
func (x *Message) fastReadField42(buf []byte, _type int8) (offset int, err error) {
	...
	x.Field40 = &ov
	ov.Field42, offset, err = fastpb.ReadBool(buf[offset:], _type)
	return offset, err
}
...
func (x *Response) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Action, offset, err = fastpb.ReadString(buf[offset:], _type)
	return offset, err
}

func (x *Response) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Msg, offset, err = fastpb.ReadString(buf[offset:], _type)
	return offset, err
}
...
func (x *Message_Condition) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	...
	x.Field1 = &ov
	ov.Field2, offset, err = fastpb.ReadInt64(buf[offset:], _type)
	return offset, err
}
...
func (x *Message_Condition) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.Field4, offset, err = fastpb.ReadBool(buf[offset:], _type)
	return offset, err
}
...
func (x *Message) fastWriteField28(buf []byte) (offset int) {
	...
	for i := range x.Field28 {
		offset += fastpb.WriteInt32(buf[offset:], 28, int32(x.Field28[i]))
	}
	return offset
}
...
func (x *Message) fastWriteField31(buf []byte) (offset int) {
	...
	for i := range x.Field31 {
		offset += fastpb.WriteInt32(buf[offset:], 31, int32(x.Field31[i]))
	}
	return offset
}
...
func (x *Message) fastWriteField34(buf []byte) (offset int) {
	...
	for i := range x.Field34 {
		offset += fastpb.WriteInt32(buf[offset:], 34, int32(x.Field34[i]))
	}
	return offset
}
...
func (x *Message) fastWriteField37(buf []byte) (offset int) {
	...
	for i := range x.Field37 {
		offset += fastpb.WriteInt32(buf[offset:], 37, int32(x.Field37[i]))
	}
	return offset
}
...
func (x *Message) sizeField28() (n int) {
	...
	for i := range x.Field28 {
		n += fastpb.SizeInt32(28, int32(x.Field28[i]))
	}
	return n
}
...
func (x *Message) sizeField31() (n int) {
	...
	for i := range x.Field31 {
		n += fastpb.SizeInt32(31, int32(x.Field31[i]))
	}
	return n
}
...
func (x *Message) sizeField34() (n int) {
	...
	for i := range x.Field34 {
		n += fastpb.SizeInt32(34, int32(x.Field34[i]))
	}
	return n
}
...
func (x *Message) sizeField37() (n int) {
	...
	for i := range x.Field37 {
		n += fastpb.SizeInt32(37, int32(x.Field37[i]))
	}
	return n
}
